...
namespace StoreFrontLAB.Controllers
{
    ...
    public class PaymentMethodsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PaymentMethodID,Type")] PaymentMethod paymentMethod)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PaymentMethodID,Type")] PaymentMethod paymentMethod)
        {
            if (ModelState.IsValid)
            {
